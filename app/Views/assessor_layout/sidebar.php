<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/default.html " target="_blank">
      ...
      <span class="ms-1 font-weight-bold">QVC UPSI</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <div class="collapse  hide " id="accountSB">
      ...
      <li class="nav-item">
        <a data-bs-toggle="collapse" href="#appmpqua_SB_Section" class="nav-link " aria-controls="assessors_SB_Section" role="button" aria-expanded="false">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            <svg class="text-dark" width="12px" height="12px" viewBox="0 0 42 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>basket</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <ul class="nav ms-4 ps-3">
            ...
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>appmpqua/viewUni">
                ...
                <span class="sidenav-normal">List:
              </a>
            </li>
            <!-- <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>appmpqua/admin">
                <span class="sidenav-mini-icon"> TEST ADMIN </span>
                <span class="sidenav-normal">TEST ADMIN</span>
              </a>
            </li>
            <li class="nav-item ">
              <a class="nav-link " href="<?= base_url() ?>appmpqua/adminUni">
                <span class="sidenav-mini-icon"> TEST VIEW UNI </span>
                <span class="sidenav-normal">TEST VIEW </span>
              </a>
            </li> -->
          </ul>
        </div>
